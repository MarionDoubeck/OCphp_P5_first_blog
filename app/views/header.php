...
<head>
    ...
    <meta name="author" content="Marion Doubeck" />
        <title>MarionDoubeck</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand myLogo" href="/"><div>ECO</div><div>CODE</div></a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('public/images/about-bg.jpeg')">
